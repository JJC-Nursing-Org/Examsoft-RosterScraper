...
class OfflineRS:
    ...
    def run_scraper(self):
        ...
        bowl0 = soup.find_all("div", class_="grid-row__content grid-row__selectable")
        bowl = soup.find_all("div", class_="grid-row")
        ...
        for i in range(len(bowl)):
            ...
            # TODO: call this function once testing is complete
            def debug_EdgeCases():
...
#         obj.set_inp_name(f_name)
#
#     obj.set_exp_folder(sGUI.popup_get_folder("Output Folder for CSV's:"))
#     obj.set_exp_name(sGUI.popup_get_text("Name your CSV's:"))
#
#     obj.run_scraper()
#     sys.exit()
#
